...
Array3D::Array3D(CyclesGlobalState *state, const Array3DMemoryDescriptor &d)
...
{
  return make_uint3(uint32_t(size(0)), uint32_t(size(1)), uint32_t(size(2)));
}
...
CYCLES_ANARI_TYPEFOR_DEFINITION(cycles::Array3D *);

...
Array2D::Array2D(CyclesGlobalState *state, const Array2DMemoryDescriptor &d)
...
{
  return make_uint2(uint32_t(size(0)), uint32_t(size(1)));
}
...
CYCLES_ANARI_TYPEFOR_DEFINITION(cycles::Array2D *);

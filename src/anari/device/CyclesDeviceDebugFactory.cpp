...
class geometry_cone : public DebugObject<ANARI_GEOMETRY> {
   ...
   public:
   geometry_cone(DebugDevice *td, CyclesDeviceDebugFactory *factory, ANARIObject wh, ANARIObject h): DebugObject(td, wh, h) { (void)factory; }
   void setParameter(const char *paramname, ANARIDataType paramtype, const void *mem) {
      DebugObject::setParameter(paramname, paramtype, mem);
      int idx = param_hash(paramname);
      switch(idx) {
...
class geometry_curve : public DebugObject<ANARI_GEOMETRY> {
   ...
   public:
   geometry_curve(DebugDevice *td, CyclesDeviceDebugFactory *factory, ANARIObject wh, ANARIObject h): DebugObject(td, wh, h) { (void)factory; }
   void setParameter(const char *paramname, ANARIDataType paramtype, const void *mem) {
      DebugObject::setParameter(paramname, paramtype, mem);
      int idx = param_hash(paramname);
      switch(idx) {
...
class geometry_cylinder : public DebugObject<ANARI_GEOMETRY> {
   ...
   public:
   geometry_cylinder(DebugDevice *td, CyclesDeviceDebugFactory *factory, ANARIObject wh, ANARIObject h): DebugObject(td, wh, h) { (void)factory; }
   void setParameter(const char *paramname, ANARIDataType paramtype, const void *mem) {
      DebugObject::setParameter(paramname, paramtype, mem);
      int idx = param_hash(paramname);
      switch(idx) {
...
class geometry_quad : public DebugObject<ANARI_GEOMETRY> {
   ...
   public:
   geometry_quad(DebugDevice *td, CyclesDeviceDebugFactory *factory, ANARIObject wh, ANARIObject h): DebugObject(td, wh, h) { (void)factory; }
   void setParameter(const char *paramname, ANARIDataType paramtype, const void *mem) {
      DebugObject::setParameter(paramname, paramtype, mem);
      int idx = param_hash(paramname);
      switch(idx) {
...
class light_point : public DebugObject<ANARI_LIGHT> {
   ...
   public:
   light_point(DebugDevice *td, CyclesDeviceDebugFactory *factory, ANARIObject wh, ANARIObject h): DebugObject(td, wh, h) { (void)factory; }
   void setParameter(const char *paramname, ANARIDataType paramtype, const void *mem) {
      DebugObject::setParameter(paramname, paramtype, mem);
      int idx = param_hash(paramname);
      switch(idx) {
...
class sampler_image1D : public DebugObject<ANARI_SAMPLER> {
   ...
   public:
   sampler_image1D(DebugDevice *td, CyclesDeviceDebugFactory *factory, ANARIObject wh, ANARIObject h): DebugObject(td, wh, h) { (void)factory; }
   void setParameter(const char *paramname, ANARIDataType paramtype, const void *mem) {
      DebugObject::setParameter(paramname, paramtype, mem);
      int idx = param_hash(paramname);
      switch(idx) {
...
class spatial_field_structuredRegular : public DebugObject<ANARI_SPATIAL_FIELD> {
   ...
   public:
   spatial_field_structuredRegular(DebugDevice *td, CyclesDeviceDebugFactory *factory, ANARIObject wh, ANARIObject h): DebugObject(td, wh, h) { (void)factory; }
   void setParameter(const char *paramname, ANARIDataType paramtype, const void *mem) {
      DebugObject::setParameter(paramname, paramtype, mem);
      int idx = param_hash(paramname);
      switch(idx) {
...
class volume_scivis : public DebugObject<ANARI_VOLUME> {
   ...
   public:
   volume_scivis(DebugDevice *td, CyclesDeviceDebugFactory *factory, ANARIObject wh, ANARIObject h): DebugObject(td, wh, h) { (void)factory; }
   void setParameter(const char *paramname, ANARIDataType paramtype, const void *mem) {
      DebugObject::setParameter(paramname, paramtype, mem);
      int idx = param_hash(paramname);
      switch(idx) {
...
DebugObjectBase* CyclesDeviceDebugFactory::new_light(const char *name, DebugDevice *td, ANARIObject wh, ANARIObject h) {
...
DebugObjectBase* CyclesDeviceDebugFactory::new_sampler(const char *name, DebugDevice *td, ANARIObject wh, ANARIObject h) {
...
DebugObjectBase* CyclesDeviceDebugFactory::new_spatial_field(const char *name, DebugDevice *td, ANARIObject wh, ANARIObject h) {
...
DebugObjectBase* CyclesDeviceDebugFactory::new_volume(const char *name, DebugDevice *td, ANARIObject wh, ANARIObject h) {
